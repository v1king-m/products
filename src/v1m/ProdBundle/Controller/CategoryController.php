...
use v1m\ProdBundle\Entity\Category;
use v1m\ProdBundle\Form\CategoryType;
...
class CategoryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('v1mProdBundle:Category')->findAll();
     ...
     *
     * @Route("/", name="cat_create")
     * @Method("POST")
     * @Template("v1mProdBundle:Category:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('v1mProdBundle:Category')->find($id);
    ...
    */
     ...
     *
     * @Route("/{id}", name="cat_update")
     * @Method("PUT")
     * @Template("v1mProdBundle:Category:edit.html.twig")
     */
